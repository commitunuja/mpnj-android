...
import com.sholeh.marketplacenj.model.city.Result;
...
public class KotaAdapter extends BaseAdapter {
    ...
    public KotaAdapter(Activity activity, List<Result> movieItems) {
...
//        TextView tv_detail =  convertView.findViewById(R.id.tv_detail);
        ...
        tv_category.setText(m.getType()+ " "+m.getCityName());
