...
public class CONSTANTS {
    public static final String BASE_URL = "http://mp.comdev.id/"; //rubah dengan IP devicenya
    public static final String SUB_DOMAIN = "http://seller.comdev.id/assets/foto_produk/";
    public static final String FOTO_TOKO = "http://seller.comdev.id/assets/foto_toko/";
