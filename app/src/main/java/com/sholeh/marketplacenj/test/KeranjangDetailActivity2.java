...
public class KeranjangDetailActivity2 extends AppCompatActivity {
    ...
    private void tampil(){
        ...
        listChild = new HashMap<>();
            StringRequest stringRequest = new StringRequest(Request.Method.GET, "http://192.168.100.198/mpnj/public/api/keranjang?role=konsumen&id=1", new Response.Listener<String>() {
                @Override
